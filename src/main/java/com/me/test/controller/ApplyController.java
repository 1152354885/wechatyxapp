...
public class ApplyController {
    ...
    @GetMapping("/query/{id}")
    @ResponseBody
    public List<Apply> queryByApplyId(@PathVariable(value = "id") Integer apply_id) {
        Apply apply = applyService.queryByApplyId(apply_id);
    ...
    @ResponseBody
    public List<Apply> getApplyAndActivityByStep(@RequestParam("master_openid") String master_openid,
    ...
    @ResponseBody
    public List<Apply> getMyApplyAndActivityByStep(@RequestParam("apply_openid") String apply_openid,
                                                   @RequestParam("states1") String states1,
                                                   @RequestParam("states2") String states2) {

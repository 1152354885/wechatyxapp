...
public class NoticeController {
    ...
    @ResponseBody
    public String ReplyNotice(@PathVariable(value = "openid") String openid,
                              @RequestParam("states") String states) {
        // String usermessageKey = openid+"message";
        boolean hasKey = redisUtil.hasKey(String.valueOf(openid + "messagetotal"));
...
//            System.out.println(total2);
 //         redisUtil.set(String.valueOf(openid + "applytotal"), total2);
            redisUtil.set(String.valueOf(openid + "messagetotal"), total);
            ...
            redisUtil.set(String.valueOf(openid + "messagetotal"), 0);
            redisUtil.set(String.valueOf(openid + "messagelast"), 0);
...
//            redisUtil.set(String.valueOf(openid + "applylast"), 0);
    ...
    public String ClearmassageView(@PathVariable(value = "openid") String openid) {
        redisUtil.set(String.valueOf(openid + "messagelast"), (Integer.valueOf((String) redisUtil.get(openid + "messagetotal"))));
     return "已清除信息";
    }
   // 废弃接口

...
public class ActiVityController {
    ...
    @ResponseBody
    public String queryByOpenId(@PathVariable(value = "open_id")String open_id){
    ...
    @ResponseBody
    public String queryByConditionMap(@RequestParam(value = "act_type",required=false)String act_type,
        ...
        if (act_addr.length() != 0 & act_time.length() ==0 & act_type.length() == 0){
            act_time=null; act_type=null;
        } else if (act_addr.length() == 0 & act_time.length() !=0 & act_type.length() == 0) {
            act_addr=null; act_type=null;
        } else if (act_addr.length() == 0 & act_time.length() ==0 & act_type.length() != 0) {
            act_addr=null; act_time=null;
        } else if (act_addr.length() != 0 & act_time.length() ==0 & act_type.length() != 0) {
            act_time =null;
        } else if (act_addr.length() != 0 & act_time.length() !=0 & act_type.length() == 0) {
            act_type=null;
...
//    @PostMapping ("/apply")
//    @ResponseBody
//    public String getActivityAndApplyByStep(@RequestParam(value="openid")String open_id){
//
...
//    }
    ...
    @ResponseBody
    public String getWhoFollowMe(@RequestParam("openid") String open_id){

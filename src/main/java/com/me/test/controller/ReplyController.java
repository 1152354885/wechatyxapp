...
public class ReplyController {
    ...
    public String delete(@PathVariable("id") Integer id, @PathVariable("openid") String openid) {
        ...
        redisUtil.decr(openid + "messagelast", 1);
        System.out.println(redisUtil.get(openid + "messagelast"));
    ...
    @GetMapping("/person")
    @ResponseBody
    public List<Reply> queryByOpenId(@RequestParam("open_id") String open_id) {
    ...
    @GetMapping("/myreply")
    @ResponseBody
    public List<Reply> getMyReplyByMasterOpenid(@RequestParam("master_openid") String master_openid) {
    ...
    @ResponseBody
    public List<SecondReply> StringgetMySecondReplyByOpenid(@RequestParam("master_replyopenid") String master_replyopenid) {
